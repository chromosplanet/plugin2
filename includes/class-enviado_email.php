...
if ( ! class_exists( 'enviado_email', false ) ) :
	 ...
	 * @extends     WC_Email
	 */
	class enviado_email extends WC_Email {
		...
		public function __construct() {
			...
			$this->title          = __( 'Pedido enviado', 'woocommerce' );
			$this->description    = __( 'Pedido enviado', 'woocommerce' );
			$this->template_html  = 'emails/email-order-details.php';
			$this->template_plain = 'emails/plain/email-order-details.php';
...
if ( $order != 'sent' ){
		...
		public function get_default_subject() {
			return __( 'Your {site_title} order is now sent', 'woocommerce' );
		}
